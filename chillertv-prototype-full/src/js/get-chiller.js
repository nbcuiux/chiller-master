...
function renderNetwork(data) {
  ...
  link = $('<a class="get__twitter" />').text(data.linkText).attr('href', data.link).attr('target', 'blank'),
...
function renderDemandChiller(network) {
  ...
  demandFirstName = $('<div class="required">*</div><input type="text" name="firstName" placeholder="First Name" id="demandFirstName" /><span>Please enter your First Name</span>')
  .addClass('demand__input')
  .on('input', handleDemandInput),
  demandLastName = $('<div class="required">*</div><input type="text" name="lastName" placeholder="Last Name" id="demandLastName" />')
  .addClass('demand__input')
  .on('input', handleDemandInput),

  demandMail = $('<div class="demand__credits"><div class="required">*</div><input class="demand__input" type="email" name="email" placeholder="Email" id="demandEmail" /></div>')
  .on('input', handleDemandInput),
